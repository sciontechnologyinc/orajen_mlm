...
Route::resource('ecommercecontact','EcommerceContactController');

Route::resource('ecommerceaboutus','EcommerceAboutController');
...
Route::resource('companyinformations', 'CompanyinfoController');
